        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              // BANNER
              Container(
                color: camp.color.withOpacity(0.1),
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      camp.title,
                      style: TextStyle(color: camp.color, fontWeight: FontWeight.bold, fontSize: 15),
                    ),
                    Container(
                      padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
                      decoration: BoxDecoration(
                        color: camp.color.withOpacity(0.12),
                        borderRadius: BorderRadius.circular(10),
                      ),
                      child: Text(
                        camp.date,
                        style: TextStyle(color: camp.color, fontSize: 10, fontWeight: FontWeight.bold),
                      ),
                    ),
                  ],
                ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () {
                        context.go('/generation/mode');
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(content: Text('${camp.title} konsept şablonu başarıyla yüklendi!')),
                        );
                      },
                      child: const Text('Bu Kampanyaya Üretim Yap', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13)),
                    ),
                  ],
                ),
              ),
